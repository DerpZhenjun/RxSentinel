...
async def update_bilibili_video(video_item: Dict):
    ...
    save_content_item = {
        ...
        "video_url": f"https://www.bilibili.com/video/{bvid}" if bvid else f"https://www.bilibili.com/video/av{video_id}",
...
async def batch_update_bilibili_video_comments(video_id: str, comments: List[Dict], bvid: str = ""):
    if not comments:
        return
    for comment_item in comments:
        await update_bilibili_video_comment(video_id, comment_item, bvid=bvid)


async def update_bilibili_video_comment(video_id: str, comment_item: Dict, bvid: str = ""):
